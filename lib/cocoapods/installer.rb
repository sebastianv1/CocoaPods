...
module Pod
  ...
  class Installer
    ...
    def create_generator(generate_multiple_pod_projects)
    ...
    def generate_pods_project(generator = create_generator(installation_options.generate_multiple_pod_projects))
      UI.section 'Generating Pods project' do
        ...
        unless installation_options.generate_multiple_pod_projects
          generator.share_development_pod_schemes(@pods_project, development_pod_targets)
        end
        write_lockfiles
      end
    end
    ...
    #
    def development_pod_targets(pod_targets = @pod_targets || [])
