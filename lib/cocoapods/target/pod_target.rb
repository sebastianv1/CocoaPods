  ...
  class PodTarget < Target
    ...
    def header_mappings_by_file_accessor
      ...
      Hash[valid_accessors.map do |file_accessor|
        ...
        [file_accessor, header_mappings(headers_sandbox, file_accessor, file_accessor.headers)]
      end]
    end
    ...
    def public_header_mappings_by_file_accessor
      ...
      Hash[valid_accessors.map do |file_accessor|
        ...
        [file_accessor, header_mappings(headers_sandbox, file_accessor, file_accessor.public_headers)]
      end]
    end
