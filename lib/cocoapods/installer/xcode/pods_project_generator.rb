          ...
          pod_target_installation_results_hash.values.each do |pod_target_installation_result|
            ...
            dependent_targets.each do |dependent_target|
              ...
              if dependent_project != project
                project_reference = project.add_subproject_reference(dependent_project, project.dependencies_group)
                project_reference.name = dependent_project.path.basename('.*').to_s
              end
              ...
              pod_target_installation_result.test_specs_by_native_target.each do |test_native_target, test_specs|
                ...
                test_dependent_targets.each do |test_dependent_target|
                  ...
                  if dependent_test_project != project
                    project_reference = project.add_subproject_reference(dependent_test_project, project.dependencies_group)
                    project_reference.name = dependent_test_project.path.basename('.*').to_s
                  end
