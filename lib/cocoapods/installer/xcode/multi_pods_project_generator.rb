    ...
    class Xcode
      ...
      class MultiPodsProjectGenerator < PodsProjectGenerator
        ...
        def generate!
          ...
          project_paths_by_pod_targets = pod_targets.group_by { |pod_target| sandbox.pod_target_project_path(pod_target) }
